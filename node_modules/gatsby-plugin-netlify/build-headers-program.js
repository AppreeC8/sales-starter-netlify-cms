...
function validHeaders(headers) {
  ...
  return _lodash.default.every(headers, (headersList, path) => _lodash.default.isArray(headersList) && _lodash.default.every(headersList, header => _lodash.default.isString(header) && getHeaderName(header)));
}
